...
import com.slickcode.baseframework.components.BaseFocusTraversalPolicy;
...
public abstract class BasePanel extends JPanel {
	...
	public abstract void prepareTabOutOrderList();

	public void setTabOutOrderList(List<Component> componentList) {
		BaseFocusTraversalPolicy focusTraversalPolicy = new BaseFocusTraversalPolicy(
				this, componentList);
	...
	public Dimension getPreferredSize() {
		setPreferredSize(new Dimension(baseDimension.getWidth(),
				baseDimension.getHeight()));
